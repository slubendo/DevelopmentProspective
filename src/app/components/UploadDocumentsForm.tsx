...
import DEFAULT_RETRIEVAL_TEXT from "@/db/DefaultRetrievalText";
...
export function UploadDocumentsForm() {
  ...
  return (
    ...
    ></textarea>
    <button type="submit" className="shrink-0 px-8 py-4 bg-azure-blue rounded w-28">
      <div role="status" className={`${isLoading ? "" : "hidden"} flex justify-center`}>
        <svg aria-hidden="true" className="w-6 h-6 text-white animate-spin dark:text-white fill-blue-ish-gray" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
