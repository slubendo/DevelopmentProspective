...
export function ChatMessageBubble(props: { message: Message, aiEmoji?: string, sources: any[] }) {
  ...
  return (
    <div
      ...
      className={`${alignmentClassName} ${colorClassName} rounded px-4 py-2 max-w-[80%] bg-blue-300 mb-8 flex`}
    >
      <div className="mr-2">
        {prefix}
      </div>
      ...
      <div className="whitespace-pre-wrap flex flex-col">
        ...
        {props.sources && props.sources.length ? <>
          <code className="mt-4 mr-auto bg-slate-900 px-2 py-1 rounded">
            <h2>
              🔍 Sources:
            </h2>
          </code>
